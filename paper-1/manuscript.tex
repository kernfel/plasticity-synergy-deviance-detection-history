...
Deviance detection (DD) is the ability of neural systems to identify statistically surprising sensory inputs or violations of established regularities and to respond to this surprise with an increased signal. Deviance detection is a critical component of any signal processing cascade and is closely related to the concept of error signals in the predictive processing framework \citep{Bendixen2012-nx, Khouri2015-gr, Fong2020-em}. DD has been studied particularly in auditory processing with approaches from single-unit recordings \citep{Taaseh2011-gg} to EEG \citep{Winkler2012-pr}. Impairments in DD have been reported in various disorders \citep{Fong2020-em}, including autism \citep{Schwartz2018-bc} and schizophrenia \citep{Tada2019-lj}, highlighting the need to better understand its mechanistic underpinnings.

Existing models of DD place their primary focus on synaptic plasticity. While models using long-term plasticity have been proposed \citep{Wacongne2012-ah, Hertag2020-kc}, the rapid establishment of DD in vivo \citep{Taaseh2011-gg} suggests that fast-acting short-term plasticity mechanisms play a key role. Several models using synaptic short-term plasticity have been proposed \citep{Mill2011-ah, May2015-lt, Yarden2017-eh}, finding good agreement with physiological data.

Neuronal plasticity, on the other hand, has largely been neglected in previous work, used as a mere afterthought in the neuron model \citep{Mill2011-ah} or rejected a priori as incapable of producing DD \citep{Yarden2017-eh}. However, neuronal adaptation, i.e., an experience-dependent reduction in intrinsic neuronal sensitivity independent of synaptic function, is a common phenomenon in excitatory neurons \citep{Sanchez-Vives2000-df, Henze2001-xd, Sanchez-Aguilera2014-fd, Teeter2018-iz} that has been successfully used to model stimulus-specific adaptation (SSA), a precursor to and prerequisite for DD \citep{Garagnani2011-eu}. Neuronal adaptation is well placed to play a role in DD: It establishes quickly and recovers over the course of up to several seconds \citep{Henze2001-xd, Pozzorini2015-ei}, allowing it to act as a memory of recent activity in a neuron.

Here, we investigate how neuronal threshold adaptation can lead to deviance detection. Specifically, we use a spatially constrained, randomly connected network of point neurons with spike-triggered threshold adaptation and show that deviance detection emerges from this mechanism alone, requiring neither synaptic plasticity nor a tightly defined network structure. Furthermore, we model the conjunction of both neuronal and synaptic short-term plasticity, and study how these mechanisms interact within the network as it processes regular and irregular stimulus sequences.
