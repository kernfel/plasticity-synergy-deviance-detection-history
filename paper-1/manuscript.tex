...
\begin{figure*}%
    \centering
    \includegraphics{fig-threshold-initial.pdf}
    \caption{}
...
\begin{figure*}%
    \centering
    \includegraphics{fig-thresholds-follow-std.pdf}
    \caption{}
...
\begin{figure*}%
    \centering
    \includegraphics{fig-threshold-initial-withSTD.pdf}
    \caption{}
    \label{sfig4}
\end{figure*}
...
\begin{figure*}%
    \centering
    \includegraphics{fig-thresholds-follow-std-withSTD.pdf}
    \caption{}
    \label{sfig5}
\end{figure*}
