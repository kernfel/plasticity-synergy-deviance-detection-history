...
\abstract{
    ...
    Further, we find that the full model with both STD and TA yields a DD signal that exceeds the sum of the DD signals in ablated models with either STD or TA turned off. We identify the cause of this in an interaction between the contribution of STD to the local suppression of neurons sensitive to the frequently presented stimulus, and the recovery of TA-derived global suppression across the network.
