...
% Vandael2020-qw report short-term facil, suggest its capability to interact multiplicatively with other forms of plasticity

% Dranias2013-ws report short-term stimulus memory in dissociated culture with time scales similar to our model

% Yarden2017-eh explain DD in their model (columns firing population spikes, suppression via STD) in a similar manner to my loc/glob suppression model, but without explicitly showing the interaction 
