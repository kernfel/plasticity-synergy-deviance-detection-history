...
We could readily identify similar patterns emerging across most networks and stimulus assignments. To show that deviance detection is robust to network and stimulus identity, we calculated the DDI and related indices mentioned above for each network, and show them in a summary plot in Figure \ref{fig2}c. We found that our model reliably produced positive mismatch indices (T = 6.67e+03, p = 9.26e-16, median 0.253; one-sided Wilcoxon signed-rank test, n = 120) while both SSA index (T = 6.19e+03, p = 9.76e-12, median 0.135) and DDI (T = 5.97e+03, p = 4.75e-10, median 0.114) were also positive, despite some outliers. This shows that our model was well behaved and suitable for an investigation of deviance detection.
