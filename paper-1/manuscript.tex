...
\begin{figure*}%
    \centering
    \includegraphics{fig-synergy.pdf}
    \caption{}
    \label{fig:synergy}
\end{figure*}
...
\begin{figure*}%
    \centering
    \includegraphics{fig-synergy-noTA.pdf}
    \caption{}
    \label{sfig-synergy}
\end{figure*}
